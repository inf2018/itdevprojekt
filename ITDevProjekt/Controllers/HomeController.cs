...
namespace ITDevProjekt.Controllers
{
    public class HomeController : Controller
    {
        ...
        //        cmd.Parameters.AddWithValue("@LangSource", it.lang_source);
        //        cmd.Parameters.AddWithValue("@LangTranslate", it.lang_translate);
        //        cmd.Parameters.AddWithValue("@TextBefore", it.text_before);
        //        cmd.Parameters.AddWithValue("@TextAfter", it.text_after);
        //        cmd.Parameters.AddWithValue("@TextToken", it.text_token);
        //        cnMySQL.Open();
        //        cmd.ExecuteReader();
        //        cnMySQL.Close();
        //        msg = "Data Inserted";
